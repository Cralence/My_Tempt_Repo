...
from mmldm.audio.audiocraft_new.models.mm_lm_ablation import LMModel_Ablation4
from mmldm.audio.audiocraft_new.models.builders import get_debug_lm_model
from mmldm.audio.audiocraft_new.models.loaders import load_mm_lm_ablation_4_model
...
class MM_Transformer(pl.LightningModule):
    def __init__(self,
        ...
        self.name = name
        self.model: LMModel_Ablation4 = self.get_pretrained_lm(name, use_autocast=autocast)
    ...
    def get_pretrained_lm(self, name: str = 'facebook/musicgen-melody', device=None, use_autocast=True):
        ...
        lm = load_mm_lm_ablation_4_model(name, device=device, use_autocast=use_autocast)
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.stage == 'train_music_motion':
            ...
            B, K, T = music_code.shape
            codes = torch.zeros((B, K, T * 2), device=music_code.device, dtype=torch.long)
            codes[:, :, ::2] = music_code
            codes[:, :, 1::2] = motion_code
