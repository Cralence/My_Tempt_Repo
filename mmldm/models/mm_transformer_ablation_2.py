...
from mmldm.audio.audiocraft_new.models.mm_lm_ablation import LMModel_Ablation2
from mmldm.audio.audiocraft_new.models.builders import get_debug_lm_model
from mmldm.audio.audiocraft_new.models.loaders import load_mm_lm_ablation_2_model
...
class MM_Transformer(pl.LightningModule):
    def __init__(self,
        ...
        self.name = name
        self.model: LMModel_Ablation2 = self.get_pretrained_lm(name, use_autocast=autocast)
    ...
    def get_pretrained_lm(self, name: str = 'facebook/musicgen-melody', device=None, use_autocast=True):
        ...
        lm = load_mm_lm_ablation_2_model(name, device=device, use_autocast=use_autocast)
