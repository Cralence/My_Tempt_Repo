...
def main(args):
    ...
    beat_tracker_ckpt_path = '/gpfs/u/home/LMCG/LMCGnngn/scratch/yanghan/music_motion_diffusion/mmldm/audio/beat_detection/pretrained_models/baseline_v1'

    device = torch.device('cuda')

    beat_tracker_config = {
              'model_type': 'bsl_blstm',
              'model_dir': '/gpfs/u/home/LMCG/LMCGnngn/scratch/yanghan/music_motion_diffusion/mmldm/audio/beat_detection/pretrained_models/baseline_v1',
