...
from mmldm.audio.beat_detection.track_beat import get_music_beat, build_beat_tracker
...
def main(args):
    ...
    beat_tracker_config = {
              ...
              #model_dir: './mmldm/audio/beat_detection/pretrained_models/baseline_v1'
              'model_dir': '/nobackup/users/yiningh/yh/music_dance/music_motion_diffusion/mmldm/audio/beat_detection/pretrained_models/baseline_v1',
    ...
    music_data = []
    music_ignore = []
    with cs.open(pjoin(meta_dir, 'music4all_ignore_nothing.txt'), "r") as f:
