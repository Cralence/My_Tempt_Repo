...
if __name__ == "__main__":
    ...
    with open(pjoin(music_meta_dir, 'music4all_captions.json'), 'r') as caption_fd:
    ...
    while count < total_num:
        ...
        target_length = duration * 20
        target_length = min(target_length, motion.shape[0])
        target_length = (target_length // 20) * 20
        ...
        empty_waveform = torch.zeros((1, 1, target_length // 20 * 32000))
        ...
        with torch.no_grad():
            ...
            feature_263 = motion.cpu().numpy()
            feature_263 = feature_263 * motion_std + motion_mean
            feature_263 = feature_263[0]
